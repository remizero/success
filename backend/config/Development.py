...
class Development ( Default ) :
  ...
  SUCCESS_STRICT_SLASHES        = EnvVar.isTrue ( 'SUCCESS_STRICT_SLASHES' )
  SUCCESS_EXTENSION_ACL         = EnvVar.isTrue ( 'SUCCESS_EXTENSION_ACL' )
  SUCCESS_EXTENSION_CORS        = EnvVar.isTrue ( 'SUCCESS_EXTENSION_CORS' )
  SUCCESS_EXTENSION_SQLALCHEMY  = EnvVar.isTrue ( 'SUCCESS_EXTENSION_SQLALCHEMY' )
  SUCCESS_EXTENSION_EMAIL       = EnvVar.isTrue ( 'SUCCESS_EXTENSION_EMAIL' )
  SUCCESS_EXTENSION_JWT         = EnvVar.isTrue ( 'SUCCESS_EXTENSION_JWT' )
  SUCCESS_EXTENSION_MARSHMALLOW = EnvVar.isTrue ( 'SUCCESS_EXTENSION_MARSHMALLOW' )
  SUCCESS_EXTENSION_REDIS       = EnvVar.isTrue ( 'SUCCESS_EXTENSION_REDIS' )
  SUCCESS_EXTENSION_SESSION     = EnvVar.isTrue ( 'SUCCESS_EXTENSION_SESSION' )
  SUCCESS_OUTPUT_MODEL          = EnvVar.isTrue ( 'SUCCESS_OUTPUT_MODEL' )
  SUCCESS_TABLENAME_MODEL       = EnvVar.isTrue ( 'SUCCESS_TABLENAME_MODEL' )
  ...
  JWT_ACCESS_TOKEN_EXPIRES      = timedelta ( seconds = EnvVar.toInt ( 'JWT_ACCESS_TOKEN_EXPIRES' ) )
  ...
  JWT_REFRESH_TOKEN_EXPIRES     = timedelta ( seconds = EnvVar.toInt ( 'JWT_REFRESH_TOKEN_EXPIRES' ) )
  JWT_SECRET_KEY                = EnvVar.get ( 'JWT_SECRET_KEY' )
  # JWT_SESSION_COOKIE            = EnvVar.isTrue ( 'JWT_SESSION_COOKIE' )
  JWT_TOKEN_LOCATION            = EnvVar.toList ( 'JWT_TOKEN_LOCATION' )
  ...
  LOGGER_MAIL_PORT               = EnvVar.toInt ( 'LOGGER_MAIL_PORT' )
  ...
  LOGGER_MAX_BYTES               = EnvVar.toInt ( 'LOGGER_MAX_BYTES' )
  ...
  MAIL_PORT                  = EnvVar.toInt ( 'MAIL_PORT' )
  ...
  MAIL_MAX_EMAILS            = EnvVar.toInt ( 'MAIL_MAX_EMAILS' )
  ...
  REDIS_PORT             = EnvVar.toInt ( 'REDIS_PORT' )
  ...
  PERMANENT_SESSION_LIFETIME = timedelta ( seconds = EnvVar.toInt ( 'PERMANENT_SESSION_LIFETIME' ) )
  ...
  SQLALCHEMY_DB_PORT                 = EnvVar.toInt ( 'SQLALCHEMY_DB_PORT' )
